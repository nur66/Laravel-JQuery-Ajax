                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                        User</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">Nur
                                    </div>
                                </div>
                                <div class="col-auto">
            ...
            <div class="row">
                <div class="card shadow mb-4 col-xl-12 col-md-12 col-sm-12 mb-4">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between my-3">
                        ...
                        <a href="add-penjualan" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Tambah Penjualan</a>
                    </div>
                                ...
                                @foreach ($data['penjualan'] as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ url('/edit-penjualan') }}/{{ $item['id'] }}"
                                                class="btn btn-warning btn-sm" style="width: 80px">Edit</a> &nbsp;
                                            <a href="{{ url('/delete-penjualan') }}/{{ $item['id'] }}"
