            ...
            <div class="row">
                <div class="card shadow mb-4 col-xl-12 col-md-12 col-sm-12 mb-4">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between my-2 ">
                        ...
                        <a href="add-lokasi" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Tambah Lokasi</a>
                    </div>
                                ...
                                @foreach ($data['lokasi'] as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="{{ asset('image') }}/{{ $item->gambar }}" alt="image" width="100px" height="100px">
                                        </td>
                                        <td class="text-center">
                                            <a href="{{ url('/edit-lokasi') }}/{{ $item['id'] }}"
                                                class="btn btn-warning btn-sm" style="width: 80px">Edit</a> &nbsp;
                                            <a href="{{ url('/delete-lokasi') }}/{{ $item['id'] }}"
